                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                        ...
                        <li class="nav-item">
                            <c:if test="${sessionScope.userid!=null}">
                                <a href="/ershoujy/authc/zhuxiao" class="nav-link logout"> <span class="d-none d-sm-inline">注销</span><i class="fa fa-sign-out"></i></a>
                            </c:if>
                            <c:if test="${sessionScope.userid==null}">
                                <a href="/ershoujy/authc/login" class="nav-link logout"> <span class="d-none d-sm-inline">登入</span><i class="fa fa-sign-in"></i></a>
                            </c:if>
                        </li>
                    </ul>
                </div>
